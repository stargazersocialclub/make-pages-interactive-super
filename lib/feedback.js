...
(function () {
  ...
  function buildUI() {
    ...
    root.innerHTML = [
      ...
      '    <button id="cf-edit-help" class="cf-btn cf-btn-small cf-edit-fmt cf-edit-help-btn" title="Quick guide (?)" aria-label="Quick guide">?</button>',
  ...
  function onResizeMove(e) {
    ...
    // snapped position (the opposite corner stays anchored).
    if (resizeStart.snapEdges) {
      if (resizeStart.cornerX === "r") {
        const snapped = snapToward(resizeStart.left + resizeStart.w + dx, resizeStart.snapEdges.xs);
        dx = snapped - resizeStart.left - resizeStart.w;
      } else {
        const snapped = snapToward(resizeStart.left + dx, resizeStart.snapEdges.xs);
        dx = snapped - resizeStart.left;
      }
      if (resizeStart.cornerY === "b") {
        const snapped = snapToward(resizeStart.top + resizeStart.h + dy, resizeStart.snapEdges.ys);
        dy = snapped - resizeStart.top - resizeStart.h;
      } else {
        const snapped = snapToward(resizeStart.top + dy, resizeStart.snapEdges.ys);
