...
(function () {
  ...
  function getCleanPageHtml() {
    ...
    const SESSION_CLASSES = [
      "cf-editing-target", "cf-editing-image", "cf-editing-container",
  ...
  // while the user is also entering element / edit / container mode.
