...
(function () {
  ...
  function buildUI() {
    ...
    root.innerHTML = [
      ...
      '    </div>',
      '    <p class="cf-hint"><strong>Highlight text</strong> to comment on a selection. <strong>Double-click text</strong> to edit it in place — toolbar has bold/italic, lists, alignment, case, font, color, border weight/color, radius. <strong>Double-click an image</strong> to drag its corners and resize (border + radius stay available). Press <kbd>E</kbd> to select elements, <kbd>M</kbd> to drag-reorder, <kbd>G</kbd> for a general note. Hold <kbd>Alt</kbd> + drag a rectangle to <strong>snapshot a region</strong>. Toggle a 24 px grid + snap from the panel. Press <kbd>?</kbd> for the full guide. <kbd>Esc</kbd> cancels.</p>',
      '  </div>',
      ...
      '        <ul>',
      '          <li>Row 1: <strong>B</strong> / <strong>I</strong> / bullet / numbered / align / case.</li>',
      '          <li>Row 2: font family / size / color / background / reset.</li>',
      '          <li>Row 3: border weight / border color / border radius — number inputs have custom <kbd>▲</kbd>/<kbd>▼</kbd> spinners.</li>',
